...
python3 healpix2CAR.py TOnly_la280.fits template_small.txt -O map -v -W 2
python3 healpix2CAR.py TOnly_la225.fits template_small.txt -O map -v -W 2
python3 healpix2CAR.py TOnly_la145.fits template_small.txt -O map -v -W 2
