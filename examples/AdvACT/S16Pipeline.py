...
process=subprocess.run(['sbatch', 'PS_S16_f150_auto_realspace.sh'], stdout=subprocess.PIPE)
...
process=subprocess.run(['sbatch', '--depend=afterok:%s' % (jobnum), 'MFMF_S16_auto.sh'], 
