...
process=subprocess.run(['sbatch', 'PS_S18_f150_auto_daynight.sh'], stdout=subprocess.PIPE)
...
process=subprocess.run(['sbatch', '--depend=afterok:%s' % (jobnum), 'MFMF_S18_auto_daynight.sh'], 
